...
cfg.robbery = { -- list of robberies
	...
	["fleeca"] = { 
	  ...
	  dist = 15.0, rob = 300, wait = 600, cops = 4, stars = 2, min = 80000, max = 200000
	},
	["fleeca2"] = { 
	  name = "Banco do Brasil (Rodovia)", 
