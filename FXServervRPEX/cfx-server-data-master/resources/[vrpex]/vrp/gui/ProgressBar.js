    ...
    if(anchor_index >= 0){
      if(anchor_name == "minimap"){ //MINIMAP
        ...
        if ($(window).width() >= 1920) {
          //set size
          this.div.style.width = this.div_label.style.width = (width-5)+"px";
          this.div_inner.style.height = this.div.style.height = this.div_label.style.height = (8)+"px";
          ...
          this.div.style.top = (document.body.offsetHeight-cfg.anchor_minimap_bottom+198)+"px";
        }
        else if ($(window).width() == 1366 ) {
          //set size
          this.div.style.width = this.div_label.style.width = (94.5)+"px";
