...
local lang = {
  ...
  cityhall = {
    ...
    menu = {
      title = "🆔 Identidade",
      info = "<em>Nome: </em>{1}<br /><em>Primeiro Nome: </em>{2}<br /><em>Idade: </em>{3}<br /><em>RG°: </em>{4}<br /><em>Telefone: </em>{5}<br /><em>Endereço: </em>{7}, {6}"
    }
  },
  police = {
    title = "👮 Policia",
  ...
  phone = {
    ...
    directory = {
      ...
      call = {
        title = "Ligar",
        not_reached = "~r~ n°{1} não alcançado."
      }
    },
    sms = {
    ...
    call = {
      ...
      notify_refused = "Ligação para ~b~ {1}... ~r~ foi recusou."
    },
    hangup = {
      title = "Desligar",
