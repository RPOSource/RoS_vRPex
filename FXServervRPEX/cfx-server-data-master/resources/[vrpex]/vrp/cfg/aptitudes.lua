...
cfg.gaptitudes = {
  ["physical"] = {
    _title = "Físico",
    ["strength"] = {"Força", 30, 105} -- required, level 3 to 6 (by default, can carry 10kg per level)
  },
  ["Ciência"] = {
    _title = "Ciência",
    ["Produtos quimicos"] = {"Study of chemicals", 0, -1}, -- example
    ["Matemática"] = {"Study of mathematics", 0, -1} -- example
  }
}
